...
CEntryFrameWnd3::CEntryFrameWnd3(void)
{
...
LPCTSTR CEntryFrameWnd3::GetWindowClassName() const 
{ 
	return _T("CefBrowserFrameWnd"); 
}

void CEntryFrameWnd3::OnFinalMessage(HWND hWnd)
{
	WindowImplBase::OnFinalMessage(hWnd);
	delete this; 
}

void CEntryFrameWnd3::InitWindow()
{
	
}

CControlUI* CEntryFrameWnd3::CreateControl(LPCTSTR pstrClass, CPaintManagerUI *pManager)
{    
	return NULL;
}

CDuiString CEntryFrameWnd3::GetSkinFile()
{
	return _T("analyze_films\\analyze_films.xml");
}

CDuiString CEntryFrameWnd3::GetSkinFolder()
{
	return CDuiString(CPaintManagerUI::GetInstancePath()) + _T("skin\\");

}

LRESULT CEntryFrameWnd3::OnSize(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	//
...
void    CEntryFrameWnd3::Notify(TNotifyUI& msg) 
{
...
LRESULT CEntryFrameWnd3::HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	LRESULT lRes = 0;
